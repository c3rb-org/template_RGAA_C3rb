...
if(JDEBUG) : ?>	
	...
	<script src="<?php echo $tmplpath; ?>/js/bootstrap.js" type="text/javascript" defer></script>
	<script src="<?php echo $tmplpath; ?>/js/bootstrap-accessibility.js" type="text/javascript" defer></script> <!-- https://paypal.github.io/bootstrap-accessibility-plugin/demo.html -->
	<script src="<?php echo $tmplpath; ?>/js/stacktable.js" type="text/javascript" defer></script> <!-- https://paypal.github.io/bootstrap-accessibility-plugin/demo.html -->
	<script src="<?php echo $tmplpath; ?>/js/template.js" type="text/javascript" defer></script>
<?php else : ?> 
	<script src="<?php echo $tmplpath; ?>/js/bootstrap.min.js" type="text/javascript" defer></script>
	<!-- <script src="<?php echo $tmplpath; ?>/js/bootstrap-accessibility.min.js" type="text/javascript" defer></script> -->
	<script src="<?php echo $tmplpath; ?>/js/stacktable.min.js" type="text/javascript" defer></script>

...
<div class="profile-edit<?php echo $this->pageclass_sfx?>">
	...
	<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-horizontal " enctype="multipart/form-data">
	...
	<?php endif; ?>
		...
		<div class="form-group">
			<div class="controls">
				<button type="submit" class="btn btn-default"><span><?php echo JText::_('JSUBMIT'); ?></span></button>

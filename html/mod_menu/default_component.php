...
if (!empty($item->anchor_title)) {
	if (!empty($is_active)) {
	$title = 'aria-label=" '. $item->anchor_title .' - Page active"';
	} else {
...
if ($item->menu_image)
{
	...
	$linktype = '<img class="margeright" alt="" class="margeright" aria-hidden="true" src="' . $item->menu_image . '" /><span class="image-title">' . $item->title . '</span> ' : //Pas de 'alt' car image décorative
